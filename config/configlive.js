...
module.exports = {
  ...
  apay: {
    ...
    webhook_url:
      ...
      "https://api.mybest11bd.com/api/user/apay/webhook",
    return_url:
      process.env.APAY_RETURN_URL ||
      "https://api.mybest11bd.com/api/user/apay/payment-callback",
    webhook_deposit_url:
      process.env.APAY_WEBHOOK_DEPOSIT_URL ||
      "https://api.mybest11bd.com/api/user/apay/webhook/deposit",
    webhook_withdrawal_url:
      process.env.APAY_WEBHOOK_WITHDRAWAL_URL ||
      "https://api.mybest11bd.com/api/user/apay/webhook/withdrawal",
